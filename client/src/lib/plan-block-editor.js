 ...
 *
 * Carried over from app/static/js/plan-block-editor.js unchanged apart from the
 * wrapper: it was written to be storage-agnostic - it calls an injected onSave
 * and knows nothing about a server - which is exactly what a local-first client
 * needs. Rewriting 1500 lines of contenteditable to gain nothing would have been
...
export function mount(container, options) {
    return new PlanBlockEditor(container, options);
}

export { parseMarkdown, serializeBlocks };
